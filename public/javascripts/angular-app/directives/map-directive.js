angular.module('app').directive('mapChart', ['d3', '$rootScope', 'myConfig', '$timeout',
        ...
        return {
            ...
            compile: function(elements, attrs, transclude) {
                ...
                var millingGroup = group
                    .append('g')
                    .attr('class', "millingGroup")
                    .attr('transform', 'translate(' + 220 + ',' + 15 + ')');

                var millingShadow1 = millingGroup
                    .append('g')
                    .attr('class', "milling1 shadow")
                ...
                var millingShadow2 = millingGroup
                    .append('g')
                    .attr('class', "milling1 shadow")
                    .attr('transform', 'translate(' + 41 + ',' + 1 + ')')
                    .append('path')
                    .attr('d', millingSvg)
                    .style("fill", "black")
                    .attr("transform", "scale(0.35,0.35)");
                ...
                var millingShadow3 = millingGroup
                    .append('g')
                    .attr('class', "milling1 shadow")
                    .attr('transform', 'translate(' + 81 + ',' + 1 + ')')
                    .append('path')
                    .attr('d', millingSvg)
                    .style("fill", "black")
                    .attr("transform", "scale(0.35,0.35)");
                ...
                var millingShadow4 = millingGroup
                    .append('g')
                    .attr('class', "milling1 shadow")
                    .attr('transform', 'translate(' + 121 + ',' + 1 + ')')
                    .append('path')
                    .attr('d', millingSvg)
                    .style("fill", "black")
                    .attr("transform", "scale(0.35,0.35)");
                ...
                var millingShadow5 = millingGroup
                    .append('g')
                    .attr('class', "milling1 shadow")
                    .attr('transform', 'translate(' + 161 + ',' + 1 + ')')
                    .append('path')
                    .attr('d', millingSvg)
                    .style("fill", "black")
                    .attr("transform", "scale(0.35,0.35)");
                ...
                var latheGroup = group
                    .append('g')
                    .attr('class', "latheGroup")
                    .attr('transform', 'translate(' + 120 + ',' + 20 + ')');


                var latheShadow1 = latheGroup
                    .append('g')
                    .attr('class', "lathe1 shadow")
                    .attr('transform', 'translate(' + 1 + ',' + 1 + ')')
                    .append('path')
                    .attr('d', latheSvg)
                    .style("fill", "black")
                ...
                var latheShadow2 = latheGroup
                    .append('g')
                    .attr('class', "lathe2 shadow")
                ...
                var latheShadow3 = latheGroup
                    .append('g')
                    .attr('class', "lathe3 shadow")
                    .attr('transform', 'translate(' + 1 + ',' + 46 + ')')
                    .append('path')
                    .attr('d', latheSvg)
                    .style("fill", "black")
                    .attr("transform", "scale(0.35,0.35)");
                ...
                return function(scope, element, attrs) {
                    ...
                    scope.$watch('$root.currentReading', function() {

                        console.log("currentReading", $rootScope.currentReading);
